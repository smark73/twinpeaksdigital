					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="entry-content clearfix">
							...
							<div class="photometa clearfix">
								<div class="EXIF">
									<h4><?php _e( 'Image Data', 'it-l10n-Builder-Cohen' ); ?></h4>
									...
									<?php if ( is_attachment() ) : ?>
										<?php
											...
											$meta_fields = array(
												'camera'            => __( 'Camera', 'it-l10n-Builder-Cohen' ),
												'created_timestamp' => __( 'Date Taken', 'it-l10n-Builder-Cohen' ),
												'aperture'          => __( 'Aperture', 'it-l10n-Builder-Cohen' ),
												'focal_length'      => __( 'Focal Length', 'it-l10n-Builder-Cohen' ),
												'iso'               => __( 'ISO', 'it-l10n-Builder-Cohen' ),
												'shutter_speed'     => __( 'Shutter Speed', 'it-l10n-Builder-Cohen' ),
												'credit'            => __( 'Credit', 'it-l10n-Builder-Cohen' ),
												'copyright'         => __( 'Copyright', 'it-l10n-Builder-Cohen' ),
												'title'             => __( 'Title', 'it-l10n-Builder-Cohen' ),
											);
										?>
										
										<table>
											<tr>
												<th scope="row"><?php _e( 'Dimensions', 'it-l10n-Builder-Cohen' ); ?></th>
