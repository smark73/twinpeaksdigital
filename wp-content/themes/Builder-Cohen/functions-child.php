...
// Load translations
load_theme_textdomain( 'it-l10n-Builder-Cohen', get_stylesheet_directory() . '/lang' );
...
if ( ! function_exists( 'it_builder_loaded' ) ) {
	function it_builder_loaded() {
		builder_register_module_style( 'image', 'No Margin/Padding', 'image-no-spacing' );
		builder_register_module_style( 'image', 'Full Layout Width', 'image-full-window' );
		builder_register_module_style( 'navigation', 'Light/White', 'light-navigation' );
		builder_register_module_style( 'header', 'Dark Blue', 'dark-blue-header' );
	}
}
